 ...
 */
#define CCM_ANALOG_TUPLE(reg, shift) ((((uintptr_t)(&((CCM_ANALOG_Type *)0U)->reg) & 0xFFFFU) << 16U) | (shift))
...
typedef uintptr_t clock_root_control_t;
    #define kCLOCK_RootM4 ((uintptr_t)(&(CCM)->ROOT[1].TARGET_ROOT))         /*!< ARM Cortex-M4 Clock control name.*/
    ...
    #define kCLOCK_RootSai1 ((uintptr_t)(&(CCM)->ROOT[75].TARGET_ROOT))  /*!< SAI1 Clock control name.*/
    ...
    #define kCLOCK_RootSai4 ((uintptr_t)(&(CCM)->ROOT[78].TARGET_ROOT))  /*!< SAI4 Clock control name.*/
...
typedef enum _clock_rootmux_spdif_clk_sel
{
    kCLOCK_SpdifRootmuxOsc24M = 0U,      /*!< SPDIF Clock from OSC 24M.*/
    kCLOCK_SpdifRootmuxAudioPll1 = 1U,   /*!< SPDIF Clock from AUDIO PLL1.*/
    kCLOCK_SpdifRootmuxAudioPll2 = 2U,   /*!< SPDIF Clock from AUDIO PLL2.*/
    kCLOCK_SpdifRootmuxVideoPll1 = 3U,   /*!< SPDIF Clock from VIDEO PLL1.*/
    kCLOCK_SpdifRootmuxSysPll1Div6 = 4U, /*!< SPDIF Clock from SYSTEM PLL1 divided by 6.*/
    kCLOCK_SpdifRootmuxOsc27m = 5U,      /*!< SPDIF Clock from OSC 27M.*/
    kCLOCK_SpdifRootmuxExtClk123 = 6U,   /*!< SPDIF Clock from External Clock1, External Clock2, External Clock3.*/
    kCLOCK_SpdifRootmuxExtClk234 = 7U,   /*!< SPDIF Clock from External Clock2, External Clock3, External Clock4.*/
} clock_rootmux_spdif_clk_sel_t;
...
typedef enum _clock_pll_bypass_ctrl
{
    kCLOCK_AudioPll1BypassCtrl = CCM_ANALOG_TUPLE(
        AUDIO_PLL1_GEN_CTRL, CCM_ANALOG_AUDIO_PLL1_GEN_CTRL_PLL_BYPASS_SHIFT), /*!< CCM Audio PLL1 bypass Control.*/

    kCLOCK_AudioPll2BypassCtrl = CCM_ANALOG_TUPLE(
        AUDIO_PLL2_GEN_CTRL, CCM_ANALOG_AUDIO_PLL2_GEN_CTRL_PLL_BYPASS_SHIFT), /*!< CCM Audio PLL2 bypass Control.*/

    kCLOCK_VideoPll1BypassCtrl = CCM_ANALOG_TUPLE(
        VIDEO_PLL1_GEN_CTRL, CCM_ANALOG_VIDEO_PLL1_GEN_CTRL_PLL_BYPASS_SHIFT), /*!< CCM Video Pll1 bypass Control.*/

    kCLOCK_DramPllInternalPll1BypassCtrl = CCM_ANALOG_TUPLE(
        DRAM_PLL_GEN_CTRL, CCM_ANALOG_DRAM_PLL_GEN_CTRL_PLL_BYPASS_SHIFT), /*!< CCM DRAM PLL bypass Control.*/

    kCLOCK_GpuPLLPwrBypassCtrl = CCM_ANALOG_TUPLE(
        GPU_PLL_GEN_CTRL, CCM_ANALOG_GPU_PLL_GEN_CTRL_PLL_BYPASS_SHIFT), /*!< CCM Gpu PLL bypass Control.*/

    kCLOCK_VpuPllPwrBypassCtrl = CCM_ANALOG_TUPLE(
        VPU_PLL_GEN_CTRL, CCM_ANALOG_VPU_PLL_GEN_CTRL_PLL_BYPASS_SHIFT), /*!< CCM Vpu PLL bypass Control.*/

    kCLOCK_ArmPllPwrBypassCtrl = CCM_ANALOG_TUPLE(
        ARM_PLL_GEN_CTRL, CCM_ANALOG_ARM_PLL_GEN_CTRL_PLL_BYPASS_SHIFT), /*!< CCM Arm PLL bypass Control.*/

    kCLOCK_SysPll1InternalPll1BypassCtrl = CCM_ANALOG_TUPLE(
        SYS_PLL1_GEN_CTRL, CCM_ANALOG_SYS_PLL1_GEN_CTRL_PLL_BYPASS_SHIFT), /*!< CCM System PLL1 bypass Control.*/

    kCLOCK_SysPll2InternalPll1BypassCtrl = CCM_ANALOG_TUPLE(
        SYS_PLL2_GEN_CTRL, CCM_ANALOG_SYS_PLL2_GEN_CTRL_PLL_BYPASS_SHIFT), /*!< CCM System PLL2 bypass Control.*/

    kCLOCK_SysPll3InternalPll1BypassCtrl = CCM_ANALOG_TUPLE(
        SYS_PLL3_GEN_CTRL, CCM_ANALOG_SYS_PLL3_GEN_CTRL_PLL_BYPASS_SHIFT), /*!< CCM System PLL3 bypass Control.*/
...
typedef enum _ccm_analog_pll_clke
{
    kCLOCK_AudioPll1Clke =
        CCM_ANALOG_TUPLE(AUDIO_PLL1_GEN_CTRL, CCM_ANALOG_AUDIO_PLL1_GEN_CTRL_PLL_CLKE_SHIFT), /*!< Audio pll1 clke */
    kCLOCK_AudioPll2Clke =
        CCM_ANALOG_TUPLE(AUDIO_PLL2_GEN_CTRL, CCM_ANALOG_AUDIO_PLL2_GEN_CTRL_PLL_CLKE_SHIFT), /*!< Audio pll2 clke */
    kCLOCK_VideoPll1Clke =
        CCM_ANALOG_TUPLE(VIDEO_PLL1_GEN_CTRL, CCM_ANALOG_VIDEO_PLL1_GEN_CTRL_PLL_CLKE_SHIFT), /*!< Video pll1 clke */
    kCLOCK_DramPllClke =
        CCM_ANALOG_TUPLE(DRAM_PLL_GEN_CTRL, CCM_ANALOG_DRAM_PLL_GEN_CTRL_PLL_CLKE_SHIFT), /*!< Dram pll clke */

    kCLOCK_GpuPllClke =
        CCM_ANALOG_TUPLE(GPU_PLL_GEN_CTRL, CCM_ANALOG_GPU_PLL_GEN_CTRL_PLL_CLKE_SHIFT), /*!< Gpu pll clke */
    kCLOCK_VpuPllClke =
        CCM_ANALOG_TUPLE(VPU_PLL_GEN_CTRL, CCM_ANALOG_VPU_PLL_GEN_CTRL_PLL_CLKE_SHIFT), /*!< Vpu pll clke */
    kCLOCK_ArmPllClke =
        CCM_ANALOG_TUPLE(ARM_PLL_GEN_CTRL, CCM_ANALOG_ARM_PLL_GEN_CTRL_PLL_CLKE_SHIFT), /*!< Arm pll clke */

    kCLOCK_SystemPll1Clke =
        CCM_ANALOG_TUPLE(SYS_PLL1_GEN_CTRL, CCM_ANALOG_SYS_PLL1_GEN_CTRL_PLL_CLKE_SHIFT), /*!< System pll1 clke */
    kCLOCK_SystemPll1Div2Clke = CCM_ANALOG_TUPLE(
        SYS_PLL1_GEN_CTRL, CCM_ANALOG_SYS_PLL1_GEN_CTRL_PLL_DIV2_CLKE_SHIFT), /*!< System pll1 Div2 clke */
    kCLOCK_SystemPll1Div3Clke = CCM_ANALOG_TUPLE(
        SYS_PLL1_GEN_CTRL, CCM_ANALOG_SYS_PLL1_GEN_CTRL_PLL_DIV3_CLKE_SHIFT), /*!< System pll1 Div3 clke */
    kCLOCK_SystemPll1Div4Clke = CCM_ANALOG_TUPLE(
        SYS_PLL1_GEN_CTRL, CCM_ANALOG_SYS_PLL1_GEN_CTRL_PLL_DIV4_CLKE_SHIFT), /*!< System pll1 Div4 clke */
    kCLOCK_SystemPll1Div5Clke = CCM_ANALOG_TUPLE(
        SYS_PLL1_GEN_CTRL, CCM_ANALOG_SYS_PLL1_GEN_CTRL_PLL_DIV5_CLKE_SHIFT), /*!< System pll1 Div5 clke */
    kCLOCK_SystemPll1Div6Clke = CCM_ANALOG_TUPLE(
        SYS_PLL1_GEN_CTRL, CCM_ANALOG_SYS_PLL1_GEN_CTRL_PLL_DIV6_CLKE_SHIFT), /*!< System pll1 Div6 clke */
    kCLOCK_SystemPll1Div8Clke = CCM_ANALOG_TUPLE(
        SYS_PLL1_GEN_CTRL, CCM_ANALOG_SYS_PLL1_GEN_CTRL_PLL_DIV8_CLKE_SHIFT), /*!< System pll1 Div8 clke */
    kCLOCK_SystemPll1Div10Clke = CCM_ANALOG_TUPLE(
        SYS_PLL1_GEN_CTRL, CCM_ANALOG_SYS_PLL1_GEN_CTRL_PLL_DIV10_CLKE_SHIFT), /*!< System pll1 Div10 clke */
    kCLOCK_SystemPll1Div20Clke = CCM_ANALOG_TUPLE(
        SYS_PLL1_GEN_CTRL, CCM_ANALOG_SYS_PLL1_GEN_CTRL_PLL_DIV20_CLKE_SHIFT), /*!< System pll1 Div20 clke */

    kCLOCK_SystemPll2Clke =
        CCM_ANALOG_TUPLE(SYS_PLL2_GEN_CTRL, CCM_ANALOG_SYS_PLL2_GEN_CTRL_PLL_CLKE_SHIFT), /*!< System pll2 clke */
    kCLOCK_SystemPll2Div2Clke = CCM_ANALOG_TUPLE(
        SYS_PLL2_GEN_CTRL, CCM_ANALOG_SYS_PLL2_GEN_CTRL_PLL_DIV2_CLKE_SHIFT), /*!< System pll2 Div2 clke */
    kCLOCK_SystemPll2Div3Clke = CCM_ANALOG_TUPLE(
        SYS_PLL2_GEN_CTRL, CCM_ANALOG_SYS_PLL2_GEN_CTRL_PLL_DIV3_CLKE_SHIFT), /*!< System pll2 Div3 clke */
    kCLOCK_SystemPll2Div4Clke = CCM_ANALOG_TUPLE(
        SYS_PLL2_GEN_CTRL, CCM_ANALOG_SYS_PLL2_GEN_CTRL_PLL_DIV4_CLKE_SHIFT), /*!< System pll2 Div4 clke */
    kCLOCK_SystemPll2Div5Clke = CCM_ANALOG_TUPLE(
        SYS_PLL2_GEN_CTRL, CCM_ANALOG_SYS_PLL2_GEN_CTRL_PLL_DIV5_CLKE_SHIFT), /*!< System pll2 Div5 clke */
    kCLOCK_SystemPll2Div6Clke = CCM_ANALOG_TUPLE(
        SYS_PLL2_GEN_CTRL, CCM_ANALOG_SYS_PLL2_GEN_CTRL_PLL_DIV6_CLKE_SHIFT), /*!< System pll2 Div6 clke */
    kCLOCK_SystemPll2Div8Clke = CCM_ANALOG_TUPLE(
        SYS_PLL2_GEN_CTRL, CCM_ANALOG_SYS_PLL2_GEN_CTRL_PLL_DIV8_CLKE_SHIFT), /*!< System pll2 Div8 clke */
    kCLOCK_SystemPll2Div10Clke = CCM_ANALOG_TUPLE(
        SYS_PLL2_GEN_CTRL, CCM_ANALOG_SYS_PLL2_GEN_CTRL_PLL_DIV10_CLKE_SHIFT), /*!< System pll2 Div10 clke */
    kCLOCK_SystemPll2Div20Clke = CCM_ANALOG_TUPLE(
        SYS_PLL2_GEN_CTRL, CCM_ANALOG_SYS_PLL2_GEN_CTRL_PLL_DIV20_CLKE_SHIFT), /*!< System pll2 Div20 clke */

    kCLOCK_SystemPll3Clke =
        CCM_ANALOG_TUPLE(SYS_PLL3_GEN_CTRL, CCM_ANALOG_SYS_PLL3_GEN_CTRL_PLL_CLKE_SHIFT), /*!< System pll3 clke */
} clock_pll_clke_t;
...
typedef enum _clock_pll_ctrl
{
    ...
    kCLOCK_AudioPll1Ctrl = CCM_ANALOG_TUPLE(AUDIO_PLL1_GEN_CTRL, CCM_ANALOG_AUDIO_PLL1_GEN_CTRL_PLL_RST_SHIFT),
    kCLOCK_AudioPll2Ctrl = CCM_ANALOG_TUPLE(AUDIO_PLL2_GEN_CTRL, CCM_ANALOG_AUDIO_PLL2_GEN_CTRL_PLL_RST_SHIFT),
    kCLOCK_VideoPll1Ctrl = CCM_ANALOG_TUPLE(VIDEO_PLL1_GEN_CTRL, CCM_ANALOG_VIDEO_PLL1_GEN_CTRL_PLL_RST_SHIFT),
    kCLOCK_DramPllCtrl = CCM_ANALOG_TUPLE(DRAM_PLL_GEN_CTRL, CCM_ANALOG_DRAM_PLL_GEN_CTRL_PLL_RST_SHIFT),
    /* Integer PLL frequency */
    kCLOCK_GpuPllCtrl = CCM_ANALOG_TUPLE(GPU_PLL_GEN_CTRL, CCM_ANALOG_GPU_PLL_GEN_CTRL_PLL_RST_SHIFT),
    kCLOCK_VpuPllCtrl = CCM_ANALOG_TUPLE(VPU_PLL_GEN_CTRL, CCM_ANALOG_VPU_PLL_GEN_CTRL_PLL_RST_SHIFT),
    kCLOCK_ArmPllCtrl = CCM_ANALOG_TUPLE(ARM_PLL_GEN_CTRL, CCM_ANALOG_ARM_PLL_GEN_CTRL_PLL_RST_SHIFT),
    kCLOCK_SystemPll1Ctrl = CCM_ANALOG_TUPLE(SYS_PLL1_GEN_CTRL, CCM_ANALOG_SYS_PLL1_GEN_CTRL_PLL_RST_SHIFT),
    kCLOCK_SystemPll2Ctrl = CCM_ANALOG_TUPLE(SYS_PLL2_GEN_CTRL, CCM_ANALOG_SYS_PLL2_GEN_CTRL_PLL_RST_SHIFT),
    kCLOCK_SystemPll3Ctrl = CCM_ANALOG_TUPLE(SYS_PLL3_GEN_CTRL, CCM_ANALOG_SYS_PLL3_GEN_CTRL_PLL_RST_SHIFT),
} clock_pll_ctrl_t;
