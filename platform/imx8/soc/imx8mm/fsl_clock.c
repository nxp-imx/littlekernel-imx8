...
uint32_t CLOCK_GetSaiFreq(clock_root_control_t sai_root)
{
    switch (sai_root)
    {
        case kCLOCK_RootSai1:
        case kCLOCK_RootSai2:
        case kCLOCK_RootSai3:
        case kCLOCK_RootSai4:
    ...
    switch (CLOCK_GetRootMux(sai_root))
    {
        ...
        case kCLOCK_SaiRootmuxVideoPll1:
            freq = CLOCK_GetPllFreq(kCLOCK_VideoPll1Ctrl);
            break;
        case kCLOCK_SaiRootmuxOsc27m:
            freq = OSC27M_CLK_FREQ;
            break;
        case kCLOCK_SaiRootmuxExtClk123:
        case kCLOCK_SaiRootmuxExtClk234:
        default:
            return 0;
    }
...

{
    ...
    case kCLOCK_VideoPll1Ctrl:
        ...
        break;
    default:
        printlk(LK_NOTICE, "%s:%d: Pll with %#x is not a fractional PLL\n", __PRETTY_FUNCTION__, __LINE__, pll_id);
        return;
    }
